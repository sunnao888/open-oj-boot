package com.sunnao.oj.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${open-oj.websocket.sender-rocketmq.topic}",
        consumerGroup = "${open-oj.websocket.sender-rocketmq.consumer-group}",
