...
public class ProjectReactor {
    ...
    private static final String ARTIFACT_ID = "open-oj";
    private static final String PACKAGE_NAME = "com.sunnao.oj";
    private static final String TITLE = "乐扣";
    ...
    public static void main(String[] args) {
        ...
        String artifactIdNew = "open-oj";
        String packageNameNew = "com.sunnao.oj";
        String titleNew = "乐扣";
