package com.sunnao.oj.module.system.service.social;
...
import com.sunnao.oj.framework.common.enums.UserTypeEnum;
import com.sunnao.oj.framework.common.pojo.PageResult;
import com.sunnao.oj.framework.common.util.cache.CacheUtils;
import com.sunnao.oj.framework.common.util.http.HttpUtils;
import com.sunnao.oj.framework.common.util.object.BeanUtils;
import com.sunnao.oj.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.sunnao.oj.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.sunnao.oj.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.sunnao.oj.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.sunnao.oj.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.sunnao.oj.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.sunnao.oj.module.system.dal.dataobject.social.SocialClientDO;
import com.sunnao.oj.module.system.dal.mysql.social.SocialClientMapper;
import com.sunnao.oj.module.system.dal.redis.RedisKeyConstants;
import com.sunnao.oj.module.system.enums.social.SocialTypeEnum;
import com.sunnao.oj.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.sunnao.oj.framework.common.util.collection.MapUtils.findAndThen;
import static com.sunnao.oj.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.sunnao.oj.framework.common.util.json.JsonUtils.toJsonString;
import static com.sunnao.oj.module.system.enums.ErrorCodeConstants.*;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${open-oj.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${open-oj.wxa-subscribe-message.miniprogram-state:formal}")
