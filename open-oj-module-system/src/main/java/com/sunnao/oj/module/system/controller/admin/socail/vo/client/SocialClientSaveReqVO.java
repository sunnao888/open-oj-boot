package com.sunnao.oj.module.system.controller.admin.socail.vo.client;
...
import com.sunnao.oj.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "open-oj商城")
